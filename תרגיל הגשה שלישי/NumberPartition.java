...
public class NumberPartition{
	...
	*/
	...
	// function prints all numberPartions strings, using recursive function to check for all options
	...
	// function goes through all the options to build N length 0,1 strings and prints them if they're partitions
